...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='single',
            name='preferences',
            field=models.ManyToManyField(related_name=b'preferences', null=True, to='date.Preference', blank=True),
